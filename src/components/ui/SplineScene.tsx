  ...
  return (
    <div className={`${className} relative flex items-center justify-center`}>
      ...
      <div className="relative flex flex-col items-center gap-4 text-center px-6">
        ...
        >
          <span style={{ display: "inline-block", width: 0, height: 0, borderTop: "5px solid transparent", borderBottom: "5px solid transparent", borderLeft: "8px solid rgba(78,222,163,0.9)" }} />
