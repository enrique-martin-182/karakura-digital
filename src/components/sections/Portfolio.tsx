          ...
          {projects.map((project, i) => (
            <ScrollReveal key={project.title} delay={i * 100}>
              <a
                ...
                className="group block relative rounded-2xl overflow-hidden border border-outline-variant/30 hover:border-primary-container/40 transition-all duration-500 hover:-translate-y-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-container"
                style={{
