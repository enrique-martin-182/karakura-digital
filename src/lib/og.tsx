...
async function loadFont() {
  ...
  return fetch(ttfUrl).then((r) => r.arrayBuffer()).catch(() => null);
}
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20, position: "relative" }}>
          <div
            style={{
              fontSize: title.length > 30 ? 58 : 76,
              fontWeight: 800,
              lineHeight: 1.05,
              color: "white",
        ...
        >
          <span style={{ fontSize: 20, fontWeight: 700, color: "rgba(78,222,163,0.7)", letterSpacing: "0.01em" }}>
            karakuradigital.es
          </span>
          <span style={{ fontSize: 15, color: "rgba(255,255,255,0.25)", letterSpacing: "0.08em", textTransform: "uppercase" }}>
            Córdoba · España
          </span>
        </div>
      </div>
